...
namespace SJAHE_BASE_LIBRARY.SecurityHelpers
{
    public class UserMembershipProvider : MembershipProvider
    {
        public override bool ValidateUser(string username, string password)
        {
            ...
            sjahe_dbcontext db = new sjahe_dbcontext();
            ...
            if (getUser != null)
            {
                ...
                {
                    var user = dc.SC_User.Where(a => a.UserName.Equals(username)).FirstOrDefault(); //&& a.UserPassword.Equals(decryptpassword)).FirstOrDefault();
                    if (user != null)
                    {
                        string decryptpassword = SecurityEncryptedDecrypted.DecryptText(user.UserPassword, Seed);
