...
{
    [Table("PY_EmployeeFormulaNonFixedComponent")]
    public class PY_EmployeeFormulaNonFixedComponent
    {
        [Key]
        public int FormulaNonFixedComponentID { get; set; }

        [DisplayName("Non Fixed Component")]
